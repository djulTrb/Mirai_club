...
const resources = {
  en: {
    translation: {
      ...
      "home_hero_desc": "Build the Future with AI.<br/>Join Tizi Ouzou's student AI community.<br/>Practical workshops, real-world projects, hackathons and inspiring talks with industry experts.",
      ...
      "mission_ed_title": "Educate", "mission_ed_desc": "Practical workshops and training on machine learning,<br/>deep learning, and essential toolchains.",
      "mission_in_title": "Inspire", "mission_in_desc": "Representing Tizi Ouzou in national hackathons<br/>and innovative AI competitions.",
      "mission_co_title": "Connect", "mission_co_desc": "An active community of passionate university students,<br/>open to all skill levels.",
      "mission_ex_title": "Experiment", "mission_ex_desc": "Concrete projects, from prototyping to deployment,<br/>developed collaboratively in teams.",
  ...
  fr: {
    translation: {
      ...
      "home_hero_desc": "Construisez le Futur avec l'IA.<br/>Rejoignez la communauté IA étudiante de Tizi Ouzou.<br/>Ateliers pratiques, projets concrets, hackathons et conférences inspirantes avec des experts.",
      ...
      "mission_ed_title": "Éduquer", "mission_ed_desc": "Ateliers pratiques et formations sur le machine learning,<br/>le deep learning et les outils essentiels.",
      "mission_in_title": "Inspirer", "mission_in_desc": "Représenter Tizi Ouzou dans les hackathons<br/>nationaux et compétitions IA.",
      "mission_co_title": "Connecter", "mission_co_desc": "Une communauté active d'étudiants passionnés,<br/>ouverte à tous les niveaux.",
      "mission_ex_title": "Expérimenter", "mission_ex_desc": "Des projets concrets, du prototypage au déploiement,<br/>développés en équipe.",
  ...
  ar: {
    translation: {
      ...
      "mission_ed_title": "تعليم", "mission_ed_desc": "ورش عمل عملية وتدريب على التعلم الآلي،<br/>التعلم العميق، والأدوات الأساسية.",
      "mission_in_title": "إلهام", "mission_in_desc": "تمثيل تيزي وزو في مسابقات الهاكاثون<br/>الوطنية ومسابقات الذكاء الاصطناعي.",
      "mission_co_title": "تواصل", "mission_co_desc": "مجتمع نشط من طلاب الجامعات المتحمسين،<br/>مفتوح لجميع مستويات المهارة.",
      "mission_ex_title": "تجربة", "mission_ex_desc": "مشاريع ملموسة، من النمذجة إلى<br/>النشر، يتم تطويرها بشكل تعاوني.",
