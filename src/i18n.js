...
const resources = {
  ...
  fr: {
    translation: {
      ...
      "home_join_circle": "Rejoindre le Club MIRAI *",
  ...
  ar: {
    translation: {
      ...
      "home_cta_title": "انظر إلى الذكاء الاصطناعي <pill1></pill1> <brDesktop/> من <brDesktop/> منظور مختلف <pill2></pill2>", "home_cta_desc": "",
      "home_join_circle": "Join Mirai Club *",
