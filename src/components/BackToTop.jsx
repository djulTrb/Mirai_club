  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
      <button 
        ...
        className="w-[54px] h-[54px] rounded-full bg-white/80 backdrop-blur-md border border-black dark:border-white shadow-xl flex items-center justify-center text-black hover:bg-[#240046] hover:text-white transition-all duration-300 group dark:bg-surface-container dark:text-white dark:hover:bg-[#c77dff] dark:hover:text-[#240046]" 
