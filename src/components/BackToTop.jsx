  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
      <button 
        ...
        className="w-[54px] h-[54px] rounded-[1.25rem] bg-white/80 backdrop-blur-md border border-black shadow-xl flex items-center justify-center text-black hover:bg-[#240046] hover:text-white transition-all duration-300 group dark:bg-white dark:border-white dark:text-[#240046] dark:hover:bg-[#c77dff] dark:hover:text-[#240046]" 
